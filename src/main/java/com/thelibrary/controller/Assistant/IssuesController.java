...
public class IssuesController {
    ...
    @FXML
    private TextField issueIDTXT;
    @FXML
    private TextField fineAmountTXT;
    ...
    public void payFine(ActionEvent event) {
        try {
            IssueDAOImpl issueDAO = new IssueDAOImpl();
            issueDAO.payFine(issueIDTXT.getText());
            Notifications.create().text("Fine : "+fineAmountTXT.getText()+" paid").show();
        }catch (Exception exception){
            Notifications.create().text("An error occured! Please contact the system administrator").show();
        }
