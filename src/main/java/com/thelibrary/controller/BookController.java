...
public class BookController{
    ...
    protected void confirmBorrow(ActionEvent event) {
        ...
        issueDAO.createIssue(this.book.getMediaid(), usernameTXT.getText(), Integer.parseInt(periodTXT.getText()));
        Notifications.create().text("Your reservation has been made. Please approach a librarian to complete the process").show();
    }
